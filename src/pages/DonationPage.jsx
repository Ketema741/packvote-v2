        ...
        <Paper elevation={3} sx={{ p: 4, borderRadius: 3 }}>
          ...
          <Box className="donation-card" sx={{ 
            ...
            <Box className="donation-text" sx={{ maxWidth: '700px' }}>
              ...
              <Typography paragraph className="support-message">
            ...
            <Button 
              ...
              className="primary-button"
              sx={{ display: 'flex', alignItems: 'center', gap: 2, py: 1.5, px: 3 }}
            >
              <img 
            ...
            <Box className="thank-you-note" sx={{ textAlign: 'center', mt: 3 }}>
              ...
              <Typography variant="body2" color="text.secondary" className="small-text">
